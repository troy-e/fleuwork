    ...
    <div class="container mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-4">
                <form action="{{ route('admin.departments.search') }}" method="GET"
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex items-center space-x-2">
                                    <!-- Edit -->
                                    <a href="{{ route('admin.departments.edit', $department->id) }}" title="Edit Data">
                                    ...
                                    <!-- Hapus -->
                                    <button type="button" onclick="showDeleteModal('{{ route('admin.departments.destroy', $department->id) }}')" title="Hapus Data">
